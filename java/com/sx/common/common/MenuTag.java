...
//				}else{
//					if(i==0){
//						out.println("/images/right/tagm_off_bg.gif' style='padding-left:10px;padding-top:2px'><a href='"+DemoAppConfig.getAPPCONTEXT()+href[i]+"' class='link04'>"+menuname[i]+"</a>");
//					}else{
//						out.println("/images/right/tagm_off_bg.gif' style='padding-top:2px'><a href='"+DemoAppConfig.getAPPCONTEXT()+href[i]+"' class='link04'>"+menuname[i]+"</a>");
//					}
//
//					if(i<menuname.length-1){
//						if(checked[i+1]){
